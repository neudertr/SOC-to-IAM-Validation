...
audit = AuditLog(live=globals().get("PIPELINE_VERBOSE", False))
final_cpe_results = []
pipeline_summary = {}
...
audit.step("PROMPT", "Prompt constructed", {"prompt_tokens": int(inputs.input_ids.shape[1]), "input_device": input_device})
...
audit.step("LLM", "Generation finished", {"generation_time_s": round(gen_time, 2), "raw_preview": decoded[:160]})
